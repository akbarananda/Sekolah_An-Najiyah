...
@section('content')
    <div class="mt-32 text-center">
        ...
        <p class="mt-10 text-xl sm:text-xl font-semibold text-gray-500 dark:text-gray-300" data-aos="zoom-out-down"
            data-aos-duration="2000">
            "Menjadi Sekolah Unggul, Berwawasan Global berdasarkan nilai-nilai Keislaman berhaluan Ahlus Sunnah Waljamaah"
        </p>
        ...
        <p class="mt-10 text-xl sm:text-xl font-semibold text-gray-500 dark:text-gray-300" data-aos="zoom-out-up"
            data-aos-duration="2000">
            Melaksanakan Pendidikan Berdasarkan Agamis yag meningkatkann kualitas keimanan dan ketaqwaan peserta didik.
        </p>
        <p class="mt-5 text-xl sm:text-xl font-semibold text-gray-500 dark:text-gray-300" data-aos="zoom-out-up"
            data-aos-duration="2000">
            Melaksanakan kurikulum berbasis kompetensi dengan lebih memusatkan pada peningkatan sains da teknologi yang
            sesuai dengan perkembangan modern di era globalisasi..
        </p>
        <p class="mt-5 text-xl sm:text-xl font-semibold text-gray-500 dark:text-gray-300" data-aos="zoom-out-up"
            data-aos-duration="2000">
            Melaksanakan strategi pembelajaran yang berorientasi peserta didik aktif, dinamis, penuh inovasi serta
            pengembangan potensi siswa seluas-luasnya.
        </p>
    </div>
                ...
                <div class="space-y-8">
                    ...
                    <div>
                        <h2 class="text-2xl font-black text-black mb-10 dark:text-white">
                            Tentang SMA An-Najiyah
                        </h2>
                        <p class="text-lg leading-relaxed font-normal text-gray-700 dark:text-gray-300">
                            Merupakan salah satu sekolah menengah yang berada di Surabaya, provinsi Jawa Timur. Adapun Nomor
                            pokok sekolah nasional (NPSN) untuk SMA AN- NAJIYAH SURABAYA ini adalah 20532380.

                            Sekolah ini menyediakan berbagai fasilitas penunjang pendidikan bagi anak didiknya. Terdapat
                            guru-guru dengan kualitas terbaik yang kompeten dibidangnya, kegiatan penunjang pembelajaran
                            seperti ekstrakurikuler (ekskul), organisasi siswa, komunitas belajar, tim olahraga, dan
                            perpustakaan sehingga siswa dapat belajar secara maksimal. Proses belajar dibuat senyaman
